                ...
                <div className="grid grid-cols-3 items-center h-20">
                    ...
                    <div className="hidden md:flex items-center justify-end gap-4">
                        {isAuthenticated ? (
                            ...
                            <Link
                                to="/login"
                                className="px-5 py-2 rounded-lg border border-white/20 text-sm font-semibold text-white hover:border-neon-teal/60 hover:text-neon-teal hover:bg-neon-teal/5 transition-all duration-300"
                            >
                                Login
                            </Link>
                        )}
