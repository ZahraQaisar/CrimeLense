                ...
                <div className="grid md:grid-cols-4 gap-12 mb-16">
                    ...
                    <div>
                        ...
                        <ul className="space-y-4">
                            ...
                            <li><Link to="/#features" className="text-gray-500 hover:text-neon-teal transition-colors text-sm">Features</Link></li>
                            <li><Link to="/prediction" className="text-gray-500 hover:text-neon-teal transition-colors text-sm">Prediction</Link></li>
                            <li><Link to="/about" className="text-gray-500 hover:text-neon-teal transition-colors text-sm">About</Link></li>
                        </ul>
                    </div>
