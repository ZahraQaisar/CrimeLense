            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="text-center mb-8">
                    <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">
                        Live Crime <span className="text-neon-teal">Heatmap</span>
                    </h1>
                    <p className="text-xl text-gray-400 max-w-2xl mx-auto">
                        Explore real-time crime density across different areas to make informed decisions about your safety.
                    </p>
                </div>

                {/* Controls Header */}
                <div className="flex flex-wrap items-center justify-between gap-4 p-4 glass-panel rounded-xl border border-white/5 mb-6">
                ...
                {/* Map Container */}
                <div className="h-[600px] relative rounded-xl overflow-hidden glass-panel border border-white/5 mb-8">
                    <CrimeMap
                ...
                <div className="flex justify-center">
                    <button
                        ...
                        className="group px-8 py-4 rounded-xl bg-neon-teal text-deep-navy font-bold text-lg hover:bg-white transition-all duration-300 shadow-[0_0_20px_rgba(20,241,217,0.4)] hover:shadow-[0_0_30px_rgba(20,241,217,0.6)] flex items-center gap-3"
                    >
                        Predict Crime Risk
