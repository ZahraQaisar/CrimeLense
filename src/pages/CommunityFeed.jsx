            ...
            <div className="max-w-3xl mx-auto">
                ...
                <div className="flex items-center justify-between mb-6">
                    ...
                    <button 
                        ...
                        className="px-4 py-2 bg-neon-teal text-deep-navy font-bold rounded-lg hover:bg-neon-teal/90 transition-all flex items-center gap-2 text-sm shadow-[0_0_15px_rgba(20,241,217,0.3)]"
                    >
                            ...
                            <form onSubmit={handleSubmit} className="glass-panel p-6 rounded-2xl border border-neon-teal/30 relative">
                                ...
                                <div className="space-y-4">
                                    ...
                                    <button 
                                        ...
                                        className="w-full py-3 bg-neon-teal text-deep-navy font-bold rounded-xl flex items-center justify-center gap-2 hover:bg-neon-teal/90 transition-all disabled:opacity-50"
                                    >
                                        {isSubmitting ? (
