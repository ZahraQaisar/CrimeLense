        ...
        <div style={{ position: 'relative', minHeight: '100vh', isolation: 'isolate' }}>
            ...
            >
                ...
                <style>{`
                    ...
                    [data-theme="light"] .cl-hero-overlay {
                        background: radial-gradient(ellipse at 50% 50%, rgba(0,158,128,0.04) 0%, rgba(220,228,240,0.30) 100%);
                    }
                    .cl-hero-fade {
                        background: linear-gradient(to bottom, transparent, #0b0e14);
                    }
                    [data-theme="light"] .cl-hero-fade {
                        background: linear-gradient(to bottom, transparent, #eef3f9);
                    }
                `}</style>
                ...
                >
                    <motion.span
                        ...
                        className="px-4 py-1.5 rounded-full border border-neon-teal/40 bg-neon-teal/10 text-neon-teal text-sm font-semibold tracking-widest uppercase mb-6 inline-block"
                    ...
                    <motion.p
                        className="text-lg text-gray-400 max-w-2xl mx-auto mb-9 leading-relaxed"
                    ...
                    <motion.div
                        ...
                        className="group mx-auto mt-6 text-left border border-neon-teal/60 rounded-xl cursor-pointer max-w-[560px] transition-all duration-300 cl-community-strip relative z-10 shadow-[0_0_20px_rgba(38,204,194,0.15)] hover:shadow-[0_0_30px_rgba(38,204,194,0.3)] hover:-translate-y-1"
                    ...
                    >
                        <style>{`
                            ...
                            [data-theme="light"] .cl-community-strip {
                            ...
                            [data-theme="light"] .cl-community-strip .cl-comm-text-1 {
                            ...
                            [data-theme="light"] .cl-community-strip .cl-comm-text-2 {
                                color: #6b7280; /* muted */
                            }
