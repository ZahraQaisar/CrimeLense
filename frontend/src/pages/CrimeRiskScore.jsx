...
const mockResults = {
    'central': { label: 'HIGH RISK', trend: 'Stable' },
    'hollywood': { label: 'MODERATE RISK', trend: 'Improving' },
    'westla': { label: 'SAFE', trend: 'Improving' },
    'wilshire': { label: 'MODERATE RISK', trend: 'Worsening' },
    'pacific': { label: 'LOW RISK', trend: 'Stable' },
    'newton': { label: 'HIGH RISK', trend: 'Worsening' },
};
            ...
            <div className="max-w-4xl mx-auto">
                ...
                <form onSubmit={handleSearch} className="flex gap-3 mb-8">
                    <div className="flex-1">
                        <Input
                            placeholder="e.g. Central, Hollywood, Pacific…"
                            icon={MapPin}
                            value={query}
