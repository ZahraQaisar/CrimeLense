...
const mockData = {
    central: { label: 'HIGH RISK', trend: 'Worsening', change: '+8% compared to last quarter' },
    hollywood: { label: 'MODERATE RISK', trend: 'Stable', change: 'No significant change from last quarter' },
    'westla': { label: 'LOW RISK', trend: 'Improving', change: 'Incidents decreased 22% compared to last quarter' },
    wilshire: { label: 'MODERATE RISK', trend: 'Stable', change: 'Incidents stable compared to last quarter' },
    pacific: { label: 'LOW RISK', trend: 'Improving', change: 'Incidents decreased 12% compared to last quarter' },
    newton: { label: 'HIGH RISK', trend: 'Worsening', change: '+14% compared to last quarter' },
};
...
const suggestions = AREA_NAMES.slice(0, 6);
