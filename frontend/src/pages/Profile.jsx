...
const Profile = () => {
    ...
    const [savedAreas, setSavedAreas] = useState([
        { id: 1, name: 'Central', risk: 'HIGH' },
        { id: 2, name: 'West LA', risk: 'LOW' },
        { id: 3, name: 'Hollywood', risk: 'MODERATE' },
    ]);
                        ...
                        <div className="glass-panel p-6 rounded-2xl border border-white/5 text-center">
                            <div className="relative inline-block mb-4">
                                ...
                                <button 
                                    ...
                                    className="btn-primary btn-sm absolute bottom-0 right-0 p-2 rounded-full"
                                >
                                    <Camera size={18} />
                                </button>
                                <input 
                        ...
                        >
                            ...
                            <form onSubmit={handleChangePassword} className="space-y-4">
                                ...
                                <div className="flex gap-3 pt-4">
                                    <button type="submit" className="btn-primary flex-1 justify-center">Update Password</button>
                                    <button type="button" onClick={() => setShowChangePassword(false)} className="btn-ghost flex-1 justify-center">Cancel</button>
                                </div>
                            </form>
                        </motion.div>
                    </motion.div>
