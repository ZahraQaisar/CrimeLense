                ...
                <div className="grid md:grid-cols-4 gap-12 mb-16">
                    ...
                    <div>
                        ...
                        <ul className="space-y-3">
                            ...
                            <li><Link to="/app/predict" className="text-gray-500 hover:text-neon-teal transition-colors text-sm">Risk Prediction</Link></li>
                            <li><Link to="/app/safe-route" className="text-gray-500 hover:text-neon-teal transition-colors text-sm">Safe Route</Link></li>
                            <li><Link to="/app/compare" className="text-gray-500 hover:text-neon-teal transition-colors text-sm">Compare Areas</Link></li>
