...
import { Menu, X, Shield, User, LogOut, ChevronDown, BarChart2, MapPin, Lightbulb, Radar, Clock, ShieldCheck, Award, Users, Map } from 'lucide-react';
...
const Navbar = () => {
    ...
    return (
        <nav className={`absolute top-0 left-0 w-full z-50 transition-all duration-500 border-b ${scrolled
                    ...
                    <Link to="/" className="flex items-center gap-2 group w-fit">
                        <div className="relative flex items-center justify-center w-10 h-10 rounded-xl bg-gradient-to-tr from-neon-teal/10 to-blue-600/10 shadow-[0_0_10px_rgba(20,241,217,0.1)] group-hover:shadow-[0_0_15px_rgba(20,241,217,0.2)] transition-all duration-300 border border-neon-teal/20">
                            <svg viewBox="0 0 100 100" className="w-full h-full p-2" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <path d="M 50 90 A 40 40 0 0 1 10 50" stroke="currentColor" strokeWidth="10" strokeLinecap="round" className="text-white" />
                                {/* Inner aperture core */}
